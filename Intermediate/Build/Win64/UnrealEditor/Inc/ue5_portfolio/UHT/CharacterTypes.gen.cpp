...
// End Cross Module References
	...
	static UEnum* ECharacterState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECharacterState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ue5_portfolio_ECharacterState, (UObject*)Z_Construct_UPackage__Script_ue5_portfolio(), TEXT("ECharacterState"));
		}
	...
	static UEnum* EActionState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EActionState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ue5_portfolio_EActionState, (UObject*)Z_Construct_UPackage__Script_ue5_portfolio(), TEXT("EActionState"));
		}
	...
	static UEnum* EEnemyState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EEnemyState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ue5_portfolio_EEnemyState, (UObject*)Z_Construct_UPackage__Script_ue5_portfolio(), TEXT("EEnemyState"));
		}
	...
	static UEnum* EDeathPose_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EDeathPose.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ue5_portfolio_EDeathPose, (UObject*)Z_Construct_UPackage__Script_ue5_portfolio(), TEXT("EDeathPose"));
		}
