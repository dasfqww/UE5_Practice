...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling_MetaData[] = {
		{ "Category", "Movement" },
		{ "ModuleRelativePath", "Public/Character/GreatSwordAnimInstance.h" },
	};
#endif
	void Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling_SetBit(void* Obj)
	{
		((UGreatSwordAnimInstance*)Obj)->isFalling = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling = { "isFalling", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UGreatSwordAnimInstance), &Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling_SetBit, METADATA_PARAMS(Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling_MetaData)) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGreatSwordAnimInstance_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGreatSwordAnimInstance_Statics::NewProp_isFalling,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Practice_Source_ue5_portfolio_Public_Character_GreatSwordAnimInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGreatSwordAnimInstance, UGreatSwordAnimInstance::StaticClass, TEXT("UGreatSwordAnimInstance"), &Z_Registration_Info_UClass_UGreatSwordAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGreatSwordAnimInstance), 352651303U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Practice_Source_ue5_portfolio_Public_Character_GreatSwordAnimInstance_h_2999244868(TEXT("/Script/ue5_portfolio"),
