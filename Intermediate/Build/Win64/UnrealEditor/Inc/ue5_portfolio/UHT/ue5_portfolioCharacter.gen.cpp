...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_Aue5_portfolioCharacter_Statics::NewProp_ComboActionData_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Combat" },
		{ "ModuleRelativePath", "ue5_portfolioCharacter.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_Aue5_portfolioCharacter_Statics::NewProp_ComboActionData = { "ComboActionData", nullptr, (EPropertyFlags)0x0040000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(Aue5_portfolioCharacter, ComboActionData), Z_Construct_UClass_UUPComboActionData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_Aue5_portfolioCharacter_Statics::NewProp_ComboActionData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_Aue5_portfolioCharacter_Statics::NewProp_ComboActionData_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_Aue5_portfolioCharacter_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_Aue5_portfolioCharacter_Statics::NewProp_ComboActionData,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Practice_Source_ue5_portfolio_ue5_portfolioCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_Aue5_portfolioCharacter, Aue5_portfolioCharacter::StaticClass, TEXT("Aue5_portfolioCharacter"), &Z_Registration_Info_UClass_Aue5_portfolioCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(Aue5_portfolioCharacter), 1453989958U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5_Practice_Source_ue5_portfolio_ue5_portfolioCharacter_h_2275609507(TEXT("/Script/ue5_portfolio"),
